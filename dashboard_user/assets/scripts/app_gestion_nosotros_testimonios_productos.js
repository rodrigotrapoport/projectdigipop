...
function cargarDatos() {
    $.ajax({
        ...
        success: function (response) {
            ...
            templa_productos = ``;
            for (ie in productos) { 
                for (pr in productos[ie]){
                    /* if (productos[ie][pr]['visibilidades'] == "si") { */
                        templa_productos += ` <option value="${productos[ie][pr]['nombre']}">${productos[ie][pr]['nombre']}</option> `;
                        console.log(templa_productos);
                    /* }; */
                };     
            };
            console.log("Template Productos: "+ templa_productos);
            ...
            for (z in testimonios) {  
                templete_testimonios += `
                                        <tr idTestimonio="${testimonios[z]['id']}">
                                            ...
                                            <td> ${testimonios[z]['nombreProducto']}</td>
                                            <td>
            ...
            $('#testimonio_relacionado').html(templa_productos);
...
$(document).on('click', '.btn_cop_eq', function () {
    ...
    $.ajax({
        ...
        success: function (response) {
            ...
            console.log("Equipo objetos: " + equipo);
            productos = lineas.productos;
            console.log("Producto objeto: " + productos);
            console.log("JSON esta cargado!");
            id_equipo_ultimo=``;
            for (wi in equipo) {  
    ...
    $.ajax({
        ...
        success: function (response) {
            ...
            for (ie in productos) {
                for (pr in productos[ie]) {
                    /* if (productos[ie][pr]['visibilidades'] == "si") { */
                    templat_productos += ` <option value="${productos[ie][pr]['nombre']}">${productos[ie][pr]['nombre']}</option> `;
                    console.log(templa_productos);
                    /* }; */
                };
            };
            templat_productos += `<option value="${testimonios[editar_cliente]['nombreProducto']}" selected>${testimonios[editar_cliente]['nombreProducto']}</option> `;
            ...
            $('#testimonio_relacionado').html(templat_productos);
...
$(document).on('click', '.btn_cop_te', function () {
    ...
    $.ajax({
        ...
        success: function (response) {
            ...
            console.log("Equipo objetos: " + testimonios);
            productos = lineas.productos;
            console.log("Servicios objeto: " + productos);
            console.log("JSON esta cargado!"); 
            id_cliente_ultimo = ``;
            ...
            for (ie in productos) {
                for (pr in productos[ie]) {
                    /* if (productos[ie][pr]['visibilidades'] == "si") { */
                    template_productos += ` <option value="${productos[ie][pr]['nombre']}">${productos[ie][pr]['nombre']}</option> `;
                    console.log(templa_productos);
                    /* }; */
                };
            };
            template_productos += `<option value="${testimonios[copiar_cliente]['nombreProducto']}" selected>${testimonios[copiar_cliente]['nombreProducto']}</option> `;
            ...
            $('#testimonio_link').val(link);
            $('#testimonio_comentario').val(comentario);
            $('#testimonio_relacionado').html(template_productos);
            $('#testimonio_cal').html(calificacion);
            $('#testimonio_imagen').val(imagen);
