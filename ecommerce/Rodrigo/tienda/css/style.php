...
Header ("Content-type: text/css; charset=utf-8");
    ...
    ///////// COLORES DE FONDO /////////	
require('../../config/assets/php/config_productsBeta.php');
$colores = json_decode($jsonConfigProductos, true);
...
/*---Media Queries --*/
@media (max-width: 992px) { /* tamaño tablet */
	.social a {
		font-size: 4em;
		padding: 2rem;
	}
...
@media (max-width: 768px) { /* tamaño tablet y cel */
	.carousel-caption {
	top: 50%;
	}
	/* sombre del titulo */
