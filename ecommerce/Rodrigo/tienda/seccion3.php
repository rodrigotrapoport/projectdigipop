...
require("../config/assets/php/config_Products.php");

$jsonS = json_decode($jsonProductos,true); // servicios disponibles
$jsonConfig = json_decode($jsonConfigProductos,true); // configuracion de servicios
